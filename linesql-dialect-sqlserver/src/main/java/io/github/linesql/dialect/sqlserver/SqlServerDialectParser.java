...
public class SqlServerDialectParser implements DialectParser {
    private static final SimpleTokenLineageParser.Config CONFIG =
            SimpleTokenLineageParser.Config.forDialect(SqlDialect.SQLSERVER, "SQL Server", "SQLSERVER")
                    ...
                    .drop(SqlServerLineageLexer.DROP)
                    .truncate(SqlServerLineageLexer.TRUNCATE)
                    .alter(SqlServerLineageLexer.ALTER)
                    .show(SqlServerLineageLexer.SHOW)
                    .describe(SqlServerLineageLexer.DESCRIBE)
                    .comment(SqlServerLineageLexer.COMMENT)
                    ...
                    .rename(SqlServerLineageLexer.RENAME)
                    .to(SqlServerLineageLexer.TO)
                    .column(SqlServerLineageLexer.COLUMN)
