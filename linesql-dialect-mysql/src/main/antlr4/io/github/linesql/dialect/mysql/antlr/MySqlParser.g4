...
statement
    ...
    | logfileGroupStatement                                          #logfileGroupStmt
...
indexCacheStatement
    : CACHE INDEX indexCacheTableSpec (COMMA indexCacheTableSpec)* IN identifier
    | LOAD INDEX INTO CACHE indexCacheTableSpec (COMMA indexCacheTableSpec)* (IGNORE LEAVES)?
    ;

indexCacheTableSpec
    : multipartIdentifier ((INDEX | KEY) LPAREN identifierList RPAREN)?
    ;
