...
nonReservedKeyword
    ...
    | DATABASE | DATAFILE | DEALLOCATE | DISCARD | DIV | DOUBLE | DUMPFILE | EMPTY | ENCRYPTION | ENFORCED | ENGINE | ENDS | ERROR | ERRORS | ESCAPE | ESCAPED | EVENT | EVENTS | EVERY | EXCHANGE | EXECUTE | EXISTS | EXPIRE | EXPLAIN | EXTERNAL | EXTENDED | EXTENDED_NOADDR | FAILED_LOGIN_ATTEMPTS | FALSE | FAST | FIELDS | FIRST | FLUSH | FOLLOWING | FOR | FORCE | FOREIGN | FORMAT | FULLTEXT | FUNCTION | GENERATED | GET_FORMAT | GLOBAL | GRANT | GRANTS | GROUP | HANDLER | HIGH_PRIORITY | IF | IGNORE | IMPORT | INDEX | INSERT_METHOD | INSTANCE | INTEGER | INTERVAL | INVOKER | ISSUER | JSON_TABLE | JSON_VALUE | KEY | KILL | LAST | LATERAL | LIKE | LIMIT | LINES | LOCK | LOCKED | LOGS | MASTER | MAX_ROWS | MEDIUM | MERGE | MIN_ROWS | MINUS_SET | MOD | MODE | MODIFY | NAMES | NATIONAL | NCHAR | NESTED | NEVER | NEXT | NO | NONE | NO_WRITE_TO_BINLOG | NOWAIT | NULL | NVARCHAR | OF
