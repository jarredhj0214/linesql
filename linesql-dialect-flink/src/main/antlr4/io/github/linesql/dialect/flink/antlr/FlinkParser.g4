...
nonReservedKeyword
    ...
    | GENERATED | GROUPING | HASH | HOP | HOUR | IF | ILIKE | INCLUDING | INTERVAL | JAVA
    ...
    | REMOVE | RESUME | RESTRICT | ROLLUP | ROW | ROWS | SAVEPOINT | SCALA | SCALAR | SCHEMA | SECOND | SEMI_JOIN | SERDE | SERDEPROPERTIES | SESSION | SET | SETS | SHOW | SKIP_KEYWORD | SOME | SORT | STATEMENT | STOP | STORED
    ...
    | UNBOUNDED | UNCONDITIONAL | UNKNOWN | UNLOAD | UNNEST | UNSET | USE | USER | VALUE | VALUES | VIEW | VIEWS | VIRTUAL | WATERMARK | WINDOW | WITHIN | WITHOUT | WRAPPER
    ;
