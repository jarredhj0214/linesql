...
oracleSchemaObjectControlStatement
    ...
    | CREATE (OR REPLACE)? TYPE multipartIdentifier (AS | IS) (OBJECT | TABLE) .+?
    | ALTER TYPE multipartIdentifier .+?
    | DROP TYPE multipartIdentifier (FORCE | VALIDATE)?
...
alterTableStatement
    ...
    | ALTER TABLE multipartIdentifier ADD CONSTRAINT identifier PRIMARY KEY LPAREN identifierList RPAREN #alterTableAddPrimaryKeyConstraint
    | ALTER TABLE multipartIdentifier ADD CONSTRAINT identifier FOREIGN KEY LPAREN localColumns=identifierList RPAREN REFERENCES refTable=multipartIdentifier (LPAREN refColumns=identifierList RPAREN)? #alterTableAddForeignKeyConstraint
    | ALTER TABLE multipartIdentifier ADD CONSTRAINT identifier CHECK LPAREN expression RPAREN #alterTableAddCheckConstraint
    | ALTER TABLE multipartIdentifier DROP CONSTRAINT identifier       #alterTableDropConstraint
...
nonReservedKeyword
    ...
    | BULK | CHECK | COLLECT | COMPLETE | CONSTRAINT | FAST | FETCH | FIRST | FLASHBACK | FOR | FORCE | FOREIGN | FUNCTION | GRANT | IF | IMMEDIATE | INDEX | INTERVAL | LAST | LATERAL | LIKE | LIMIT | MATERIALIZED | MINUS_SET | NEXT | NO | NULL
