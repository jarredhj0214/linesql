...
2. Improve column lineage for PIVOT, multi-value UNPIVOT, standalone pipe AGGREGATE output, and AUTO CDC only after target/source column semantics are clear.
