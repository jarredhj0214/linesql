...
The public regression corpus currently contains 2066 SQL cases, including 1013 column-lineage cases.

Maven:
io.github.jarredhj0214:linesql-all:1.0.0
...
- a public case-backed regression corpus with 2066 SQL cases
