...
| Oracle mode package and anonymous block | `create or replace package ...`, `create or replace package body ...`, `begin ... end`, `declare ... begin ... end`, anonymous `exception` handlers, `execute immediate`, cursor `for` loops | `oracle_mode_create_package`, `oracle_mode_create_package_body`, `oracle_mode_anonymous_begin_block`, `oracle_mode_anonymous_declare_block`, `oracle_mode_anonymous_exception_block`, `oracle_mode_anonymous_execute_immediate_block`, `oracle_mode_anonymous_cursor_loop_block` |
